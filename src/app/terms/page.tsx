...
const Terms = () => {
  return (
    <Box maxWidth="800px" mx="auto" p="8" bg="white" color="gray.800" borderRadius="md" boxShadow="md">
      ...
      <Text as={"p"}>
        Busy gestiona este sitio web. En todo el sitio, los términos &ldquo;nosotros&rdquo;, &ldquo;nos&rdquo; y &ldquo;nuestro&rdquo; se refieren en lo sucesivo a Busy. Busy ofrece esta página web, incluida toda la información, las herramientas y los servicios que se ponen en este sitio a disposición suya, el usuario, siempre y cuando acepte la totalidad de los términos, condiciones, políticas y avisos contemplados aquí.

        Al visitar nuestro sitio y / o comprarnos algo, usted interactúa con nuestro &ldquo;Servicio&rdquo; y reconoce como vinculantes los siguientes términos y condiciones (denominados en lo sucesivo &ldquo;Términos del servicio&rdquo;, &ldquo;Términos&rdquo;), incluidos aquellos términos y condiciones adicionales y las políticas que se mencionan aquí y / o disponibles por medio de hipervínculo. Estos Términos del servicio se aplican a todos los usuarios del sitio, incluyendo de manera enunciativa mas no limitativa los usuarios que son navegadores, proveedores, clientes, comerciantes y / o que aporten contenido.
      ...
      <Text as={"p"}>
        ...
        Usted reconoce y acepta que brindamos acceso a dichas herramientas &ldquo;tal como se encuentran&rdquo; y &ldquo;según disponibilidad&rdquo; sin garantías, representaciones ni condiciones de ningún tipo y sin ningún tipo de respaldo. No tendremos ninguna responsabilidad como consecuencia del uso que haga de herramientas opcionales de terceros o en relación a ellas.
      ...
      <Text as={"p"}>
        Estos Términos de servicio y cualquier política o regla de funcionamiento que hayamos publicado en este sitio o con respecto al &ldquo;Servicio&rdquo; constituye el acuerdo y el entendimiento completo entre usted y nosotros, y rigen su uso del &ldquo;Servicio&rdquo;, sustituyendo a cualquier acuerdo, comunicación o propuesta anterior o contemporánea, ya sea oral o escrita, entre usted y nosotros (incluyendo de manera enunciativa más no limitativa, las versiones anteriores de los Términos del servicio).
      ...
      <Text as={"p"}>
        Los presentes Términos del servicio y cualquier acuerdo por separado por el cual le proporcionemos Servicios se regirán e interpretarán de acuerdo con las leyes de  Mar del plata, B, 7600, Argentina.
      </Text>
      ...
      <Text as={"p"}>
        Las preguntas sobre los Términos del servicio se deben enviar a busystreetwear@gmail.com.
      </Text>
