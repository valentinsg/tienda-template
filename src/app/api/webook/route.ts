...
import { sendOrderConfirmationEmail } from '../payments/emailService';
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (payment.status === 'approved') {
      ...
      // Fetch updated payment record with tracking code
      ...
      if (updatedRecord) {
        ...
        await sendOrderConfirmationEmail(updatedRecord);
      }
